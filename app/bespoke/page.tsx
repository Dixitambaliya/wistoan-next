    ...
    <div className="pt-32 pb-24 px-6 md:px-12 min-h-screen">
      <div className="max-w-[1000px] mx-auto">
        ...
        >
          ...
          <h1 className="font-serif text-5xl md:text-6xl tracking-wide mb-6">Your Vision,<br />Our Craft</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            <motion.div
              ...
              className="p-8 border border-white/10 rounded-2xl hover:border-amber-500/50 transition-colors"
            >
        ...
        >
          <button className="bg-white text-black px-12 py-4 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-amber-500 hover:text-white transition-all duration-300">
